...
class RunConfig:
    ...
    evaluate_experiment: bool = False # False F
    ...
    is_dynamic_scale_factor: bool = True # False
    yolo_threshold: float = 0.3 # 0.5
    is_v2: bool = False
    is_controlnet: bool = False # False  True
    ...
    placeholder_token: str = "some" #   "some"
